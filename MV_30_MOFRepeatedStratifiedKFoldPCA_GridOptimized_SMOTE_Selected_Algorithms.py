...
filename2 = "SMOTE_DTC_Grid_Optimized_Quality.joblib"
dtc_random = joblib.load(filename2)
filename2 = "SMOTE_LSVC_Grid_Optimized_Quality.joblib"
lsvc_random = joblib.load(filename2)
filename2 = "SMOTE_GNB_Grid_Optimized_Quality.joblib"
...
models_list_expanded = ['SMOTE Grid Optimized Logistic Regression','SMOTE Grid Optimized Ridge Classifier','SMOTE Grid Optimized Gaussian Process Classifier','SMOTE Grid Optimized Decision Tree Classifier','SMOTE Grid Optimized Linear SVC','SMOTE Grid Optimized Gaussian NB']
