...
rf_2_random = RandomizedSearchCV(estimator = rf, param_distributions = random_grid, n_iter = iterations, cv = splits, scoring=make_scorer(matthews_corrcoef), random_state=1, n_jobs = None, error_score='raise')
# Fit the random search model
best_random_model_2 = rf_2_random.fit(train_features2, train_labels2)
...
# search across 100 different combinations
rf = RandomForestClassifier(random_state=1)
rf_3_random = RandomizedSearchCV(estimator = rf, param_distributions = random_grid, n_iter = iterations, cv = splits, scoring=make_scorer(matthews_corrcoef), random_state=1, n_jobs = None, error_score='raise')
# Fit the random search model
best_random_model_3 = rf_3_random.fit(train_features3, train_labels3)
