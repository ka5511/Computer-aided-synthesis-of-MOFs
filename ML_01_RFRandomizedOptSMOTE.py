...
"""
# Purpose: Perform a random search over ranges of specified parameters using stratified K-fold for cross-validation. If data augmentation is applied, the applied technique is reflected on the file title
####################################################################
...
rf_2_random = RandomizedSearchCV(estimator = pipeline, param_distributions = random_grid, n_iter = iterations, cv = splits, scoring=make_scorer(matthews_corrcoef), random_state=1, n_jobs = None, error_score='raise')
...
# Random search of parameters, using 3 fold cross validation, 
# search across 100 different combinations
rf_3_random = RandomizedSearchCV(estimator = pipeline, param_distributions = random_grid, n_iter = iterations, cv = splits, scoring=make_scorer(matthews_corrcoef), random_state=1, n_jobs = None, error_score='raise')
# Fit the random search model
