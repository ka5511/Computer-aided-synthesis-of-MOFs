...
filename2 = "SMOTE_DTC_Randomized_Optimized_Quality.joblib"
dtc_random = joblib.load(filename2)
filename2 = "SMOTE_LSVC_Randomized_Optimized_Quality.joblib"
lsvc_random = joblib.load(filename2)
filename2 = "SMOTE_GNB_Randomized_Optimized_Quality.joblib"
...
models_list_expanded = ['SMOTE Random Optimized Logistic Regression','SMOTE Random Optimized Ridge Classifier','SMOTE Random Optimized Gaussian Process Classifier','SMOTE Random Optimized Decision Tree Classifier','SMOTE Random Optimized Linear SVC','SMOTE Random Optimized Gaussian NB']
...
for model in get_models_quality():
    ...
    plot_result_MCC(models_list_expanded[i+3]+"Repeated Stratified KFold", "MCC", "Repeated KFold MOF Quality MCC Scores in "+str(splits)+" Folds", models_results_quality[i]["MCC"], models_results_quality[i]["MCC"].mean())
