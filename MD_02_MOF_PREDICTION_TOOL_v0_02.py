...
"""
# Purpose: Program the second version of the MONOSYN Prediction Tool
...
while True:
    ...
    while True:
        if metal_type == 1:
            ...
            if Co_mass>0:
                ...
                user_X_testing_reg.append(Co_mass)
                break
            else:
    ...
    while True:
        syn_time = float(input("Please enter the synthesis duration in (hr): "))
        if syn_time>0:
...
print("")
if report_reg == "Yes": # For Zinc Based MOF
    if quality != "Powder":
        ...
        if abs(meso)<0.09 and meso<0:
            meso = 0
            total_volume = micro + meso
        ...
        elif density > 0 and size > 0 and BET > 0 and micro > 0:
            data = [[quality, np.around(density,3), np.around(size,0), np.around(BET,0), np.around(micro,3), "Prediction is unreliable", "Prediction is unreliable"]]
            print (tabulate(data, headers=["MOF Quality", "Density (g/cm\u00b3)", "Average Particle Size (nm)", "BET Area (m\u00b2/g)","Micropore Volume (cm\u00b3/g)","Mesopore Volume (cm\u00b3/g)","Total Pore Volume (cm\u00b3/g)"]))
            print("\nPredictions could be unreliable, why don't you conduct the experiment physically and feed the results back to the tool to improve it?")
        elif density > 0 and size > 0 and BET > 0:
            data = [[quality, np.around(density,3), np.around(size,0), np.around(BET,0), "Prediction is unreliable", "Prediction is unreliable", "Prediction is unreliable"]]
            print (tabulate(data, headers=["MOF Quality", "Density (g/cm\u00b3)", "Average Particle Size (nm)", "BET Area (m\u00b2/g)","Micropore Volume (cm\u00b3/g)","Mesopore Volume (cm\u00b3/g)","Total Pore Volume (cm\u00b3/g)"]))
            print("\nPredictions could be unreliable, why don't you conduct the experiment physically and feed the results back to the tool to improve it?")
        else:
    ...
    if quality != "Powder":
        ...
        if density > 0 and size > 0 and BET > 0 and micro > 0 and meso >= 0:
            ...
            data = [[quality, np.around(density,3), np.around(size,0), np.around(BET,0), np.around(micro,3), "Prediction is unreliable", "Prediction is unreliable"]]
            print (tabulate(data, headers=["MOF Quality", "Density (g/cm\u00b3)", "Average Particle Size (nm)", "BET Area (m\u00b2/g)","Micropore Volume (cm\u00b3/g)","Mesopore Volume (cm\u00b3/g)","Total Pore Volume (cm\u00b3/g)"]))
            print("Predictions could be unreliable, why don't you conduct the experiment physically and feed the results back to the tool to improve it?")
        elif density > 0 and size > 0 and BET > 0:
            data = [[quality, np.around(density,3), np.around(size,0), np.around(BET,0), "Prediction is unreliable", "Prediction is unreliable", "Prediction is unreliable"]]
            print (tabulate(data, headers=["MOF Quality", "Density (g/cm\u00b3)", "Average Particle Size (nm)", "BET Area (m\u00b2/g)","Micropore Volume (cm\u00b3/g)","Mesopore Volume (cm\u00b3/g)","Total Pore Volume (cm\u00b3/g)"]))
            print("\nPredictions could be unreliable, why don't you conduct the experiment physically and feed the results back to the tool to improve it?")
