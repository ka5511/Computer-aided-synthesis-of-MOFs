...
plot_result("Repeated K-Fold Number", "Accuracy", "Optimized Repeated K-Fold MOF Shape Accuracy Scores in "+str(splits)+"  Folds", K_clf_model2_result["Training Accuracy scores"], K_clf_model2_result["Validation Accuracy scores"], K_clf_model2_result["Mean Validation Accuracy"])
plot_result("Repeated K-Fold Number", "Precision", "Optimized Repeated K-Fold MOF Shape Precision Scores in "+str(splits)+" Folds", K_clf_model2_result["Training Precision scores"], K_clf_model2_result["Validation Precision scores"], K_clf_model2_result["Mean Validation Precision"])
plot_result("Repeated K-Fold Number", "Recall", "Optimized Repeated K-Fold MOF Shape Recall Scores in "+str(splits)+" Folds", K_clf_model2_result["Training Recall scores"], K_clf_model2_result["Validation Recall scores"], K_clf_model2_result["Mean Validation Recall"])
plot_result("Repeated K-Fold Number", "F1", "Optimized Repeated K-Fold MOF Shape F1 Scores in "+str(splits)+" Folds", K_clf_model2_result["Training F1 scores"], K_clf_model2_result["Validation F1 scores"], K_clf_model2_result["Mean Validation F1 Score"])
plot_result_MCC("Repeated K-Fold Number", "MCC", "Optimized Repeated K-Fold MOF Shape MCC Scores in "+str(splits)+" Folds", K_clf_model2_result["MCC"], K_clf_model2_result["MCC"].mean())
...
# show the plot
plt.title("Optimized Repeated K-Fold MOF Shape Accuracy Scores for Different K Values", fontsize=15)
...
# show the plot
plt.title("Optimized Repeated K-Fold MOF Shape Precision Scores for Different K Values", fontsize=15)
plt.xlabel("K Value", fontsize=14)
...
# show the plot
plt.title("Optimized Repeated K-Fold MOF Shape Recall Scores for Different K Values", fontsize=15)
plt.xlabel("K Value", fontsize=14)
...
# show the plot
plt.title("Optimized Repeated K-Fold MOF Shape F1 Scores for Different K Values", fontsize=15)
plt.xlabel("K Value", fontsize=14)
...
# show the plot
plt.title("Optimized Repeated K-Fold MOF Shape MCC Scores for Different K Values", fontsize=15)
plt.xlabel("K Value", fontsize=14)
...
plot_result("Random Forest Classification", "Accuracy", "Optimized Repeated K-Fold MOF Quality Accuracy Scores in "+str(splits)+" Folds", K_clf_model3_result["Training Accuracy scores"], K_clf_model3_result["Validation Accuracy scores"], K_clf_model3_result["Mean Validation Accuracy"])
plot_result("Random Forest Classification", "Precision", "Optimized Repeated K-Fold MOF Quality Precision Scores in "+str(splits)+" Folds", K_clf_model3_result["Training Precision scores"], K_clf_model3_result["Validation Precision scores"], K_clf_model3_result["Mean Validation Precision"])
plot_result("Random Forest Classification", "Recall", "Optimized Repeated K-Fold MOF Quality Recall Scores in "+str(splits)+" Folds", K_clf_model3_result["Training Recall scores"], K_clf_model3_result["Validation Recall scores"], K_clf_model3_result["Mean Validation Recall"])
plot_result("Random Forest Classification", "F1", "Optimized Repeated K-Fold MOF Quality F1 Scores in "+str(splits)+" Folds", K_clf_model3_result["Training F1 scores"], K_clf_model3_result["Validation F1 scores"], K_clf_model3_result["Mean Validation F1 Score"])
plot_result_MCC("Random Forest Classification", "MCC", "Optimized Repeated K-Fold MOF Quality MCC Scores in "+str(splits)+" Folds", K_clf_model3_result["MCC"], K_clf_model3_result["MCC"].mean())
...
plt.plot(folds, [a_ideal for _ in range(len(folds))], color='r',label="LOOCV Score")
# show the plot
plt.title("Optimized Repeated K-Fold MOF Quality Accuracy Scores for Different K Values", fontsize=15)
plt.xlabel("K Value", fontsize=14)
plt.ylabel("Accuracy Score", fontsize=14)
plt.grid()
plt.legend()
...
plt.plot(folds, [p_ideal for _ in range(len(folds))], color='r',label="LOOCV Score")
# show the plot
plt.title("Optimized Repeated K-Fold MOF Quality Precision Scores for Different K Values", fontsize=15)
plt.xlabel("K Value", fontsize=14)
plt.ylabel("Precision Score", fontsize=14)
plt.grid()
plt.legend()
...
plt.plot(folds, [r_ideal for _ in range(len(folds))], color='r',label="LOOCV Score")
# show the plot
plt.title("Optimized Repeated K-Fold MOF Quality Recall Scores for Different K Values", fontsize=15)
plt.xlabel("K Value", fontsize=14)
plt.ylabel("Recall Score", fontsize=14)
plt.grid()
plt.legend()
...
plt.plot(folds, [f_ideal for _ in range(len(folds))], color='r',label="LOOCV Score")
# show the plot
plt.title("Optimized Repeated K-Fold MOF Quality F1 Scores for Different K Values", fontsize=15)
plt.xlabel("K Value", fontsize=14)
plt.ylabel("F1 Score", fontsize=14)
plt.grid()
plt.legend()
...
plt.errorbar(folds, mat_means, yerr=[mat_mins, mat_maxs], fmt='o')
# show the plot
plt.title("Optimized Repeated K-Fold MOF Quality MCC Scores for Different K Values", fontsize=15)
plt.xlabel("K Value", fontsize=14)
plt.ylabel("MCC Score", fontsize=14)
plt.grid()
plt.show()
