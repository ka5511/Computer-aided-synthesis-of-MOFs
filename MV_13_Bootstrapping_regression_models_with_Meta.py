...
meta_density = joblib.load(filename2)
filename2 = "Meta_Size.joblib"
meta_size = joblib.load(filename2)
filename2 = "Meta_BET.joblib"
meta_BET = joblib.load(filename2)
filename2 = "Meta_Micro.joblib"
meta_micro = joblib.load(filename2)
filename2 = "Meta_Total_Volume.joblib"
meta_total_volume = joblib.load(filename2)
...
def get_models_total_volume():
    ...
    # models.append(KNeighborsRegressor(n_neighbors=4))
    # models.append(SVR())
    models.append(meta_total_volume)
    return models
