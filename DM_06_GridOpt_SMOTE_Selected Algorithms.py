...
lr_2_random = GridSearchCV(estimator = pipeline, param_grid = random_grid, cv = splits, scoring=make_scorer(matthews_corrcoef), n_jobs = None, error_score='raise')
# Fit the random search model
best_random_model_2 = lr_2_random.fit(train_features2, train_labels2)
filename2 = "SMOTE_LR_Grid_Optimized_Shape.joblib"
...
# Random search of parameters, using 3 fold cross validation, 
# search across 100 different combinations
rc_2_random = GridSearchCV(estimator = pipeline, param_grid = random_grid, cv = splits, scoring=make_scorer(matthews_corrcoef), n_jobs = None, error_score='raise')
# Fit the random search model
best_random_model_2 = rc_2_random.fit(train_features2, train_labels2)
filename2 = "SMOTE_RC_Grid_Optimized_Shape.joblib"
joblib.dump(best_random_model_2, filename2)
...
# search across 100 different combinations
gpc_2_random = GridSearchCV(estimator = pipeline, param_grid = random_grid, cv = splits, scoring=make_scorer(matthews_corrcoef), n_jobs = None, error_score='raise')
# Fit the random search model
best_random_model_2 = gpc_2_random.fit(train_features2, train_labels2)
filename2 = "SMOTE_GPC_Grid_Optimized_Shape.joblib"
joblib.dump(best_random_model_2, filename2)
...
# search across 100 different combinations
dtc_3_random = GridSearchCV(estimator = pipeline, param_grid = random_grid, cv = splits, scoring=make_scorer(matthews_corrcoef), n_jobs = None, error_score='raise')
# Fit the random search model
best_random_model_3 = dtc_3_random.fit(train_features3, train_labels3)
filename3 = "SMOTE_DTC_Grid_Optimized_Quality.joblib"
...
random_grid = {'model__penalty': penalty,
                ...
                'model__max_iter': max_iter}
# search across 100 different combinations
lsvc_3_random = GridSearchCV(estimator = pipeline, param_grid = random_grid, cv = splits, scoring=make_scorer(matthews_corrcoef), n_jobs = None, error_score='raise')
# Fit the random search model
best_random_model_3 = lsvc_3_random.fit(train_features3, train_labels3)
filename3 = "SMOTE_LSVC_Grid_Optimized_Quality.joblib"
joblib.dump(best_random_model_3, filename3)
...
# search across 100 different combinations
gnb_3_random = GridSearchCV(estimator = pipeline, param_grid = random_grid, cv = splits, scoring=make_scorer(matthews_corrcoef), n_jobs = None, error_score='raise')
# Fit the random search model
best_random_model_3 = gnb_3_random.fit(train_features3, train_labels3)
filename3 = "SMOTE_GNB_Grid_Optimized_Quality.joblib"
joblib.dump(best_random_model_3, filename3)