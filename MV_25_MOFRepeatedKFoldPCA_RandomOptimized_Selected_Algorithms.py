...
models_list_expanded = ['Random Optimized Logistic Regression','Random Optimized Ridge Classifier','Random Optimized Gaussian Process Classifier','Random Optimized Decision Tree Classifier','Random Optimized Linear SVC','Random Optimized Gaussian NB']
