...
for model in get_models_shape():
    models_results_shape.append(cross_validation(model, principal_components, encoded_y2, KFold(n_splits = splits,shuffle=True,random_state=1)))
...
for model in get_models_quality():
    models_results_quality.append(cross_validation(model, principal_components, encoded_y3, KFold(n_splits=splits, shuffle=True,random_state=1)))
