...
for model in get_models_quality():
    ...
    plot_result(models_list_expanded[i+3]+"Repeated Stratified KFold", "Accuracy", "MOF Quality Accuracy Scores in "+str(splits)+" Folds", models_results_quality[i]["Training Accuracy scores"], models_results_quality[i]["Validation Accuracy scores"], models_results_quality[i]["Mean Validation Accuracy"])
    plot_result(models_list_expanded[i+3]+"Repeated Stratified KFold", "Precision", "MOF Quality Precision Scores in "+str(splits)+" Folds", models_results_quality[i]["Training Precision scores"], models_results_quality[i]["Validation Precision scores"], models_results_quality[i]["Mean Validation Precision"])
    plot_result(models_list_expanded[i+3]+"Repeated Stratified KFold", "Recall", "MOF Quality Recall Scores in "+str(splits)+" Folds", models_results_quality[i]["Training Recall scores"], models_results_quality[i]["Validation Recall scores"], models_results_quality[i]["Mean Validation Recall"])
    plot_result(models_list_expanded[i+3]+"Repeated Stratified KFold", "F1", "MOF Quality F1 Scores in "+str(splits)+" Folds", models_results_quality[i]["Training F1 scores"], models_results_quality[i]["Validation F1 scores"], models_results_quality[i]["Mean Validation F1 Score"])
    plot_result_MCC(models_list_expanded[i+3]+"Repeated Stratified KFold", "MCC", "MOF Quality MCC Scores in "+str(splits)+" Folds", models_results_quality[i]["MCC"], models_results_quality[i]["MCC"].mean())
