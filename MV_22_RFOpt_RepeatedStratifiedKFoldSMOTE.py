...
"""
# Purpose: Perform the indicated K-Fold cross-validation on an optimized random forest algorithms to check MOF shape/quality prediction performance. If data augmentation is applied, the applied technique is reflected on the file title
####################################################################
...
# Import the optimized model (for random search SMOTE_RF_Randomized_Optimized_Shape.joblib) and for grid search (SMOTE_RF_Grid_Optimized_Shape.joblib)
...
repeats = 10
# Models
K_clf_model2_result = cross_validation(optimized_RF_shape.best_estimator_, principal_components, encoded_y2, RepeatedStratifiedKFold(n_splits=splits, n_repeats=repeats,random_state=1))
print(K_clf_model2_result)
plot_result("Repeated Stratified K-Fold Number", "Accuracy", "SMOTE Optimized Repeated Stratified K-Fold MOF Shape Accuracy Scores in "+str(splits)+"  Folds", K_clf_model2_result["Training Accuracy scores"], K_clf_model2_result["Validation Accuracy scores"], K_clf_model2_result["Mean Validation Accuracy"])
plot_result("Repeated Stratified K-Fold Number", "Precision", "SMOTE Optimized Repeated K-Fold MOF Shape Precision Scores in "+str(splits)+" Folds", K_clf_model2_result["Training Precision scores"], K_clf_model2_result["Validation Precision scores"], K_clf_model2_result["Mean Validation Precision"])
plot_result("Repeated Stratified K-Fold Number", "Recall", "SMOTE Optimized Repeated K-Fold MOF Shape Recall Scores in "+str(splits)+" Folds", K_clf_model2_result["Training Recall scores"], K_clf_model2_result["Validation Recall scores"], K_clf_model2_result["Mean Validation Recall"])
plot_result("Repeated Stratified K-Fold Number", "F1", "SMOTE Optimized Repeated K-Fold MOF Shape F1 Scores in "+str(splits)+" Folds", K_clf_model2_result["Training F1 scores"], K_clf_model2_result["Validation F1 scores"], K_clf_model2_result["Mean Validation F1 Score"])
plot_result_MCC("Repeated Stratified K-Fold Number", "MCC", "SMOTE Optimized Repeated Stratified K-Fold MOF Shape MCC Scores in "+str(splits)+" Folds", K_clf_model2_result["MCC"], K_clf_model2_result["MCC"].mean())
...
# # show the plot
# plt.title("Optimized Repeated Stratified K-Fold MOF Shape Accuracy Scores for Different K Values", fontsize=15)
...
# # show the plot
# plt.title("Optimized Repeated Stratified K-Fold MOF Shape Precision Scores for Different K Values", fontsize=15)
# plt.xlabel("K Value", fontsize=14)
...
# # show the plot
# plt.title("Optimized Repeated Stratified K-Fold MOF Shape Recall Scores for Different K Values", fontsize=15)
# plt.xlabel("K Value", fontsize=14)
...
# # show the plot
# plt.title("Optimized Repeated Stratified K-Fold MOF Shape F1 Scores for Different K Values", fontsize=15)
# plt.xlabel("K Value", fontsize=14)
...
# # show the plot
# plt.title("Optimized Repeated Stratified K-Fold MOF Shape MCC Scores for Different K Values", fontsize=15)
# plt.xlabel("K Value", fontsize=14)
...
# Import the optimized model (for random search SMOTE_Randomized_Grid_Optimized_Quality.joblib) and for grid search (SMOTE_RF_Grid_Optimized_Quality.joblib)
filename3 = "SMOTE_RF_Grid_Optimized_Quality.joblib"
optimized_RF_quality = joblib.load(filename3)
# Conduct the cross validation
K_clf_model3_result = cross_validation(optimized_RF_quality.best_estimator_, principal_components, encoded_y3, RepeatedStratifiedKFold(n_splits=splits, n_repeats=repeats, random_state=1))
print(K_clf_model3_result)
plot_result("Repeated Stratified K-Fold Number", "Accuracy", "SMOTE Optimized Repeated Stratified K-Fold MOF Quality Accuracy Scores in "+str(splits)+" Folds", K_clf_model3_result["Training Accuracy scores"], K_clf_model3_result["Validation Accuracy scores"], K_clf_model3_result["Mean Validation Accuracy"])
plot_result("Repeated Stratified K-Fold Number", "Precision", "SMOTE Optimized Repeated K-Fold MOF Quality Precision Scores in "+str(splits)+" Folds", K_clf_model3_result["Training Precision scores"], K_clf_model3_result["Validation Precision scores"], K_clf_model3_result["Mean Validation Precision"])
plot_result("Repeated Stratified K-Fold Number", "Recall", "SMOTE Optimized Repeated K-Fold MOF Quality Recall Scores in "+str(splits)+" Folds", K_clf_model3_result["Training Recall scores"], K_clf_model3_result["Validation Recall scores"], K_clf_model3_result["Mean Validation Recall"])
plot_result("Repeated Stratified K-Fold Number", "F1", "SMOTE Optimized Repeated K-Fold MOF Quality F1 Scores in "+str(splits)+" Folds", K_clf_model3_result["Training F1 scores"], K_clf_model3_result["Validation F1 scores"], K_clf_model3_result["Mean Validation F1 Score"])
plot_result_MCC("Repeated Stratified K-Fold Number", "MCC", "SMOTE Optimized Repeated Stratified K-Fold MOF Quality MCC Scores in "+str(splits)+" Folds", K_clf_model3_result["MCC"], K_clf_model3_result["MCC"].mean())
...
# plt.plot(folds, [a_ideal for _ in range(len(folds))], color='r',label="LOOCV Score")
# # show the plot
# plt.title("Optimized Repeated Stratified K-Fold MOF Quality Accuracy Scores for Different K Values", fontsize=15)
# plt.xlabel("K Value", fontsize=14)
# plt.ylabel("Accuracy Score", fontsize=14)
# plt.grid()
# plt.legend()
...
# plt.plot(folds, [p_ideal for _ in range(len(folds))], color='r',label="LOOCV Score")
# # show the plot
# plt.title("Optimized Repeated Stratified K-Fold MOF Quality Precision Scores for Different K Values", fontsize=15)
# plt.xlabel("K Value", fontsize=14)
# plt.ylabel("Precision Score", fontsize=14)
# plt.grid()
# plt.legend()
...
# plt.plot(folds, [r_ideal for _ in range(len(folds))], color='r',label="LOOCV Score")
# # show the plot
# plt.title("Optimized Repeated Stratified K-Fold MOF Quality Recall Scores for Different K Values", fontsize=15)
# plt.xlabel("K Value", fontsize=14)
# plt.ylabel("Recall Score", fontsize=14)
# plt.grid()
# plt.legend()
...
# plt.plot(folds, [f_ideal for _ in range(len(folds))], color='r',label="LOOCV Score")
# # show the plot
# plt.title("Optimized Repeated Stratified K-Fold MOF Quality F1 Scores for Different K Values", fontsize=15)
# plt.xlabel("K Value", fontsize=14)
# plt.ylabel("F1 Score", fontsize=14)
# plt.grid()
# plt.legend()
...
# plt.errorbar(folds, mat_means, yerr=[mat_mins, mat_maxs], fmt='o')
# # show the plot
# plt.title("Optimized Repeated Stratified K-Fold MOF Quality MCC Scores for Different K Values", fontsize=15)
# plt.xlabel("K Value", fontsize=14)
# plt.ylabel("MCC Score", fontsize=14)
# plt.grid()
# plt.show()
