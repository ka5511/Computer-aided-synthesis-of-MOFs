...
models_list_expanded = ['SMOTE for Logistic Regression','SMOTE for Ridge Classifier','SMOTE for Gaussian Process Classifier','SMOTE for Decision Tree Classifier','SMOTE for Linear SVC','SMOTE for Gaussian NB']
