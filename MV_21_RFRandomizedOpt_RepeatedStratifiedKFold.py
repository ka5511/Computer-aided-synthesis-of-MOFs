...
"""
# Purpose: Perform repeated stratified K-Fold cross-validation on random forest algorithms
####################################################################
...
filename2 = "RF_Grid_Optimized_Shape.joblib"
...
plot_result("Repeated Stratified K-Fold Number", "Accuracy", "Optimized Repeated Stratified K-Fold MOF Shape Accuracy Scores in "+str(splits)+"  Folds", K_clf_model2_result["Training Accuracy scores"], K_clf_model2_result["Validation Accuracy scores"], K_clf_model2_result["Mean Validation Accuracy"])
plot_result("Repeated Stratified K-Fold Number", "Precision", "Optimized Repeated K-Fold MOF Shape Precision Scores in "+str(splits)+" Folds", K_clf_model2_result["Training Precision scores"], K_clf_model2_result["Validation Precision scores"], K_clf_model2_result["Mean Validation Precision"])
plot_result("Repeated Stratified K-Fold Number", "Recall", "Optimized Repeated K-Fold MOF Shape Recall Scores in "+str(splits)+" Folds", K_clf_model2_result["Training Recall scores"], K_clf_model2_result["Validation Recall scores"], K_clf_model2_result["Mean Validation Recall"])
plot_result("Repeated Stratified K-Fold Number", "F1", "Optimized Repeated K-Fold MOF Shape F1 Scores in "+str(splits)+" Folds", K_clf_model2_result["Training F1 scores"], K_clf_model2_result["Validation F1 scores"], K_clf_model2_result["Mean Validation F1 Score"])
plot_result_MCC("Repeated Stratified K-Fold Number", "MCC", "Optimized Repeated Stratified K-Fold MOF Shape MCC Scores in "+str(splits)+" Folds", K_clf_model2_result["MCC"], K_clf_model2_result["MCC"].mean())
...
# Import the optimized model
filename3 = "RF_Grid_Optimized_Quality.joblib"
...
plot_result("Repeated Stratified K-Fold Number", "Accuracy", "Optimized Repeated Stratified K-Fold MOF Quality Accuracy Scores in "+str(splits)+" Folds", K_clf_model3_result["Training Accuracy scores"], K_clf_model3_result["Validation Accuracy scores"], K_clf_model3_result["Mean Validation Accuracy"])
plot_result("Repeated Stratified K-Fold Number", "Precision", "Optimized Repeated K-Fold MOF Quality Precision Scores in "+str(splits)+" Folds", K_clf_model3_result["Training Precision scores"], K_clf_model3_result["Validation Precision scores"], K_clf_model3_result["Mean Validation Precision"])
plot_result("Repeated Stratified K-Fold Number", "Recall", "Optimized Repeated K-Fold MOF Quality Recall Scores in "+str(splits)+" Folds", K_clf_model3_result["Training Recall scores"], K_clf_model3_result["Validation Recall scores"], K_clf_model3_result["Mean Validation Recall"])
plot_result("Repeated Stratified K-Fold Number", "F1", "Optimized Repeated K-Fold MOF Quality F1 Scores in "+str(splits)+" Folds", K_clf_model3_result["Training F1 scores"], K_clf_model3_result["Validation F1 scores"], K_clf_model3_result["Mean Validation F1 Score"])
plot_result_MCC("Repeated Stratified K-Fold Number", "MCC", "Optimized Repeated Stratified K-Fold MOF Quality MCC Scores in "+str(splits)+" Folds", K_clf_model3_result["MCC"], K_clf_model3_result["MCC"].mean())
