...
lr_2_random = GridSearchCV(estimator = lr, param_grid = random_grid, cv = splits, scoring=make_scorer(matthews_corrcoef), n_jobs = None, error_score='raise')
...
# Random search of parameters, using 3 fold cross validation, 
# search across 100 different combinations
rc_2_random = GridSearchCV(estimator = rc, param_grid = random_grid, cv = splits, scoring=make_scorer(matthews_corrcoef), n_jobs = None, error_score='raise')
# Fit the random search model
...
# search across 100 different combinations
gpc_2_random = GridSearchCV(estimator = gpc, param_grid = random_grid, cv = splits, scoring=make_scorer(matthews_corrcoef), n_jobs = None, error_score='raise')
# Fit the random search model
...
# search across 100 different combinations
dtc_3_random = GridSearchCV(estimator = dtc, param_grid = random_grid, cv = splits, scoring=make_scorer(matthews_corrcoef), n_jobs = None, error_score='raise')
# Fit the random search model
best_random_model_3 = dtc_3_random.fit(train_features3, train_labels3)
filename3 = "DTC_Grid_Optimized_Quality.joblib"
...
# search across 100 different combinations
lsvc_3_random = GridSearchCV(estimator = lsvc, param_grid = random_grid, cv = splits, scoring=make_scorer(matthews_corrcoef), n_jobs = None, error_score='raise')
# Fit the random search model
best_random_model_3 = lsvc_3_random.fit(train_features3, train_labels3)
filename3 = "LSVC_Grid_Optimized_Quality.joblib"
joblib.dump(best_random_model_3, filename3)
...
# search across 100 different combinations
gnb_3_random = GridSearchCV(estimator = gnb, param_grid = random_grid, cv = splits, scoring=make_scorer(matthews_corrcoef), n_jobs = None, error_score='raise')
# Fit the random search model
best_random_model_3 = gnb_3_random.fit(train_features3, train_labels3)
filename3 = "GNB_Grid_Optimized_Quality.joblib"
joblib.dump(best_random_model_3, filename3)
